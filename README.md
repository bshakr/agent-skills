...
| [`capture-pairs`](./capture-pairs) | 1.0.0 | Before/after screenshot capture run by a capture subagent: detached worktree at the true fork point, private ports, injected sessions, per-shot route/theme assertions, phone overflow probe, fixture restore, rp-gallery manifest + VERDICT. Boot, session and fixture facts come from the project's own `## Capturing screenshots` section. |
